...
namespace Skyraha
{
    ...
    class AdvTexture : IDisposable
    {
        ...
        /// </summary>
        public delegate void AnimationStoppedHandler(AdvTexture sender);
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdvTexture"/> class.
        /// </summary>
        /// <param name="Texture">The texture.</param>
        public AdvTexture(Texture2D Texture)
        {
            this.Base = Texture;
        }
        ...
        public AdvTexture(Texture2D Texture, Vector2 AtlasTile, int AtlasFrameCount)
        {
            this.Base = Texture;
        ...
        public AdvTexture(Texture2D Texture, Vector2 AtlasTile, int AtlasFrameCount, float AnimationFPS)
        {
            this.Base = Texture;
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch, Rectangle Destination, Color Color, float Rotation, Vector2 Origin, SpriteEffects Effect, int DrawOrder)
        {
            ...
            spriteBatch.Draw(this.Base, Destination, this.GetSourceRectangle(), Color, Rotation, Origin, Effect, DrawOrder);
        }
        ...
        public AdvTexture Copy()
        {
            if (this.IsAnimation)
                return new AdvTexture(this.Base, this.AtlasTile, this.AtlasFrameCount, this.AnimationFPS)
                {
                    AnimationSequences = this.AnimationSequences
                };

            if(this.IsAtlas)
                return new AdvTexture(this.Base, this.AtlasTile, this.AtlasFrameCount);

            return new AdvTexture(this.Base);
        }
